  ...
  <?php
    ...
    <div class="container">
      <form action="" method="post">
         <h3 style="color:white">Đăng kí tài khoản <a href="index.php"><span>Triple &  </span><span>Trouble</span></a></h3>
         ...
         <input type="email" name="email" placeholder="Nhập tài khoản gmail" required class="text_field">
         ...
         <p>Đã có tài khoản? <br> <a class="link" href="login.php">Đăng nhập</a><a class="link" href="index.php">Trở về</a></p>
      </form>
    </div>
