...
if(isset($_POST['update'])){
    ...
    $message[]=''.$user_name.' , giỏ hàng của bạn cập nhật thành công';
}
...
<body>
    ...
    ?>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a style="color: red;" href="cart.php?remove=<?php echo $row['id'];?>"> Xóa sản phẩm</a>
                                </form>
        ...
        <a href="checkout.php" class="btn cart-btn1" style="display:<?php if($total>1){ echo 'inline-block'; }else{ echo 'none'; };?>" > &nbsp; Tiến hành thanh toán</a> <a class="cart-btn2" href="index.php">Tiếp tục mua sắm</a>
    </div>
