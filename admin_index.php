...
<html lang="en">
  <head>
    ...
    <title>Tripble & Trouble Admin</title>
  </head>
  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng đơn đang chờ xử lý </h5>
          <p class="card-text"> 
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng sách hiện có</h5>
          <p class="card-text">
          <?php echo $bookscount; ?>
          </p>
          <div class="buttons" style="display: flex; flex-direction: column;">
            <a href="total_books.php" class="btn btn-primary">Xem tất cả sách</a>
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng phản hồi của người dùng</h5>
          <p class="card-text">
          <?php echo $msgcount; ?>
          </p>
          <div class="buttons" style="display: flex; flex-direction: column;">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng Admin đã đăng ký</h5>
          <p class="card-text">
