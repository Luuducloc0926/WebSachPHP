...
if(isset($message)){
    ...
    <div class="container">
        <form action="" method="post">
            <h3 style="color:white">Đăng nhập vào <a href="index.php"><span>Triple & </span><span>Trouble</span></a></h3>
            <input type="email" name="email" placeholder="Nhập mail" required class="text_field">
            ...
            <p>Không có tài khoản? <br> <a class="link" href="Register.php">Đăng kí</a><a class="link" href="index.php">Trở về</a></p>
        </form>
    </div>
